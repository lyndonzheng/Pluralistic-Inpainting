...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--flip', action='store_true', help='if specified, do flip the image for data augmentation')
        parser.add_argument('--rotation', action='store_true', help='if specified, do rotation for data augmentation')
        parser.add_argument('--augment', action='store_true', help='if specified, do augment the image for data augmentation')
